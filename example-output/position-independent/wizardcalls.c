...
// Misc
# define HASH_SEED 8652
# define UP					-32
# define DOWN				32
# define SYSCALL_STUB_SIZE	32

// Dlls
# define NTDLL 0x525B0948 // ntdll.dll

// Functions
# define NTALLOCATEVIRTUALMEMORY 0x10F5EDBD
# define NTOPENPROCESS 0xF7A4333
# define NTWRITEVIRTUALMEMORY 0xB8361AFF
# define NTCREATETHREADEX 0xC8097B4B
# define NTPROTECTVIRTUALMEMORY 0xF761C82F
# define NTFREEVIRTUALMEMORY 0x185AB62E
